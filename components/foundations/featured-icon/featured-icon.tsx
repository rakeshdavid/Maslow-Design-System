...
const styles = sortCx({
    ...
    gradient: {
        base: "text-fg-white before:mask-b-from-0% rounded-full before:absolute before:inset-0 before:size-full before:rounded-full before:border after:absolute after:block after:rounded-full",
        sizes: {
            sm: "*:data-icon:size-4 size-8 after:size-6",
            md: "*:data-icon:size-4 size-10 after:size-7",
            lg: "*:data-icon:size-5 size-12 after:size-8",
            xl: "*:data-icon:size-5 size-14 after:size-10",
        },
        colors: {
    ...
    dark: {
        base: "text-fg-white shadow-xs-skeumorphic before:border-white/12 before:mask-b-from-0% before:absolute before:inset-px before:border",
        sizes: {
    ...
    outline: {
        ...
        sizes: {
            sm: "after:size-8.5 size-4 before:size-6",
            md: "after:size-9.5 size-5 before:size-7",
            lg: "after:size-10.5 size-6 before:size-8",
            xl: "after:size-11.5 size-7 before:size-9",
        },
        colors: {
