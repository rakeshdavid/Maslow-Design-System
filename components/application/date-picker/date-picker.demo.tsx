...
export const RangeCalendarCardDemo = () => {
    ...
    return (
        <AriaDateRangePicker aria-label="Range calendar" value={value} onChange={setValue}>
            <AriaDialog className="bg-primary ring-secondary_alt focus:outline-hidden flex rounded-2xl shadow-xl ring">
                <div className="w-38 border-secondary hidden flex-col gap-0.5 border-r border-solid p-3 lg:flex">
...
export const DarkModeDemo = () => {
    ...
    return (
        <div className="h-180 max-w-180 relative w-full [--clip-boundary:50%]">
            <div
                style={{
                    clipPath: "polygon(0 0, var(--clip-boundary) 0, var(--clip-boundary) 100%, 0 100%)",
                    transitionTimingFunction: "cubic-bezier(0.25, 0.1, 0.25, 1)",
                }}
                className="peer/light bg-tertiary outline-secondary_alt absolute inset-0 flex items-center justify-center overflow-hidden rounded-2xl outline-1 -outline-offset-1 transition-all duration-200 hover:z-10 hover:[--clip-boundary:90%] peer-hover/dark:[--clip-boundary:10%]"
            >
            ...
            <div
                ...
                className="peer/dark dark-mode bg-tertiary outline-secondary_alt absolute inset-0 flex items-center justify-center overflow-hidden rounded-2xl outline-1 -outline-offset-1 transition-all duration-200 hover:z-10 hover:[--clip-boundary:10%] peer-hover/light:[--clip-boundary:90%]"
            >
                <AriaDatePicker aria-label="Calendar card" value={value} onChange={setValue}>
                    <AriaDialog className="bg-primary ring-secondary_alt rounded-2xl shadow-xl ring">
                        <div className="flex px-6 py-5">
