            ...
            className={({ isDisabled, isFocusVisible, isSelectionStart, isSelectionEnd, isSelected, isOutsideMonth }) => {
                ...
                return cx(
                    ...
                    isLastDayOfMonth &&
                        ...
                        isBeforeEnd &&
                        isRangeCalendar &&
                        "after:to-bg-active in-[[role=gridcell]:last-child]:after:hidden after:absolute after:inset-0 after:translate-x-full after:bg-gradient-to-l after:from-transparent",
                    ...
                    isFirstDayOfMonth &&
                        ...
                        isAfterStart &&
                        isRangeCalendar &&
                        "after:to-bg-active in-[[role=gridcell]:first-child]:after:hidden after:absolute after:inset-0 after:-translate-x-full after:bg-gradient-to-r after:from-transparent",
                );
            }}
        >
                ...
                return (
                    ...
                    >
                        ...
                        {(isHighlighted || isTodayDate) && (
                            <div
                                className={cx(
                                    "size-1.25 absolute bottom-1 left-1/2 -translate-x-1/2 rounded-full",
