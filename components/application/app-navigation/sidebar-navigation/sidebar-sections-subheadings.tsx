...
export const SidebarNavigationSectionsSubheadings = ({ activeUrl = "/", items }: SidebarNavigationSectionsSubheadingsProps) => {
    ...
    const content = (
        <aside
            ...
            className="border-secondary bg-primary shadow-xs lg:w-(--width) flex h-full w-full max-w-full flex-col justify-between overflow-auto pt-4 md:border-r lg:rounded-xl lg:border lg:pt-5"
        >
