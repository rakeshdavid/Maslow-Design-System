    ...
    return (
        <>
            ...
            <header className="max-lg:hidden">
                <section
                    className={cx(
                        "bg-primary md:h-18 flex h-16 w-full items-center justify-center",
                        (!hideBorder || showSecondaryNav) && "border-secondary border-b",
                    )}
                >
                    <div className="max-w-container flex w-full justify-between pl-4 pr-3 md:px-8">
                        <div className="flex flex-1 items-center gap-4">
                            <a
                                aria-label="Go to homepage"
                                href="/"
                                className="outline-focus-ring rounded-sm focus-visible:outline-2 focus-visible:outline-offset-2"
                            >
                                <UntitledLogo className="h-8" />
                            </a>
                                    ...
                                    <AriaButton
                                        className={({ isPressed, isFocused }) =>
                                            cx(
                                                ...
                                                (isPressed || isFocused) && "outline-focus-ring rounded-full outline-2 outline-offset-2",
                                            )
                                        }
                                    >
                ...
                {showSecondaryNav && (
                    <section className={cx("bg-primary flex h-16 w-full items-center justify-center", !hideBorder && "border-secondary border-b")}>
                        <div className="max-w-container flex w-full items-center justify-between gap-8 px-8">
                            <nav>
                                <ul className="flex items-center gap-0.5">
