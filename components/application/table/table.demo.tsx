    ...
    return (
        <TableCard.Root>
            ...
            <Table aria-label="Team members" selectionMode="multiple" sortDescriptor={sortDescriptor} onSortChange={setSortDescriptor}>
                <Table.Header>
                    <Table.Head id="name" label="Name" isRowHeader allowsSorting className="max-w-1/4 w-full" />
            ...
            <PaginationPageMinimalCenter page={1} total={10} className="px-4 py-3 md:px-6 md:pb-4 md:pt-3" />
        </TableCard.Root>
    );
};
...
export const Table01DividerLineSm = () => {
    ...
    return (
        <TableCard.Root size="sm">
                        ...
                        <Table.Row id={item.username}>
                            <Table.Cell>
                                <div className="flex items-center gap-2">
                                    ...
                                    <p className="text-primary whitespace-nowrap text-sm font-medium">{item.name}</p>
                                </div>
                            </Table.Cell>
                            <Table.Cell>
                                <BadgeWithDot size="sm" color={item.status === "active" ? "success" : "gray"} type="modern">
            ...
            <PaginationCardMinimal align="right" page={1} total={10} className="px-4 py-3 md:px-5 md:pb-4 md:pt-3" />
        </TableCard.Root>
    );
};
                        ...
                        <Table.Row id={item.name}>
                            <Table.Cell>
                                <div className="flex items-center gap-3">
                                    ...
                                    <FileIcon type={item.name.split(".")[1]} theme="dark" className="not-dark:hidden size-10" />
...
export const TableNoVendorsFound = () => {
    return (
        <TableCard.Root>
            ...
            <div className="border-secondary flex justify-between gap-4 border-b px-4 py-3 md:px-6">
            ...
            <div className="flex items-center justify-center overflow-hidden px-8 pb-12 pt-10">
                <EmptyState size="sm">
            ...
            <div className="border-secondary flex items-center justify-between border-t px-6 pb-4 pt-3">
                ...
                <EmptyState size="sm">
                    ...
                    <EmptyState.Content>
                        ...
                        <EmptyState.Description>
                            ...
                            <a
                                href="#"
                                className="outline-focus-ring rounded-sm underline underline-offset-2 focus-visible:outline-2 focus-visible:outline-offset-2"
                            >
                                get in touch
                            </a>{" "}
                            for support.
