...
export const sm = ({
    ...
    return (
        <div {...otherProps} className={cx("h-29.5 w-38 relative", className)}>
...
export const md = ({
    ...
    return (
        <div {...otherProps} className={cx("h-35.75 w-45 relative", className)}>
...
export const lg = ({
    ...
    return (
        <div {...otherProps} className={cx("h-41.75 w-55 relative", className)}>
