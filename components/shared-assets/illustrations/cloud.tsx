...
export const sm = ({
    ...
    return (
        <div {...otherProps} className={cx("h-30 w-38 relative", className)}>
...
export const md = ({
    ...
    return (
        <div {...otherProps} className={cx("w-43 relative h-32", className)}>
...
export const lg = ({
    ...
    return (
        <div {...otherProps} className={cx("w-55 relative h-40", className)}>
