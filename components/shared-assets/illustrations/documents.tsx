...
export const sm = ({
    ...
    return (
        <div {...otherProps} className={cx("h-30 w-40.25 relative", className)}>
            ...
            {children && (
                <span
                    className={cx(
                        "inset-x-13 bg-alpha-black/20 text-fg-white backdrop-blur-xs absolute bottom-2 z-10 flex size-12 items-center justify-center rounded-full",
                        childrenClassName,
                    )}
                >
                    {children}
...
export const md = ({
    ...
    return (
        <div {...otherProps} className={cx("h-34.25 w-46.25 relative", className)}>
            ...
            {children && (
                <span
                    className={cx(
                        "bg-alpha-black/20 text-fg-white backdrop-blur-xs absolute bottom-3 left-1/2 z-10 flex size-14 -translate-x-1/2 items-center justify-center rounded-full",
                        childrenClassName,
                    )}
                >
                    {children}
...
export const lg = ({
    ...
    return (
        <div {...otherProps} className={cx("h-41.5 w-57.5 relative", className)}>
            ...
            {children && (
                <span
                    className={cx(
                        "bg-alpha-black/20 text-fg-white backdrop-blur-xs absolute bottom-5 left-1/2 z-10 flex size-14 -translate-x-1/2 items-center justify-center rounded-full",
                        childrenClassName,
                    )}
                >
                    {children}
