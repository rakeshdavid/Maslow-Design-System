...
export const sm = ({
    ...
    return (
        <div {...otherProps} className={cx("h-31.5 w-38 relative", className)}>
...
export const md = ({
    ...
    return (
        <div {...otherProps} className={cx("h-37 w-43 relative", className)}>
...
export const lg = ({
    ...
    return (
        <div {...otherProps} className={cx("h-45.25 w-55 relative", className)}>
