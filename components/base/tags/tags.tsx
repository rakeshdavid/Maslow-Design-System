...
export const Tag = ({
    ...
    return (
        <AriaTag
            ...
            className={(state) =>
                cx(
                    "gap-0.75 bg-primary text-secondary ring-primary focus:outline-hidden focus-visible:outline-focus-ring flex cursor-default items-center rounded-md ring-1 ring-inset focus-visible:outline-2 focus-visible:outline-offset-2",
