...
export const ButtonGroupDot = () => (
    <ButtonGroup selectedKeys={["archive"]}>
        <ButtonGroupItem id="archive" iconLeading={<Dot className="mx-0.75 text-fg-success-secondary in-disabled:text-fg-disabled_subtle size-2" />}>
            Text
        </ButtonGroupItem>
        <ButtonGroupItem id="edit" iconLeading={<Dot className="mx-0.75 text-fg-success-secondary in-disabled:text-fg-disabled_subtle size-2" />}>
            Text
        </ButtonGroupItem>
        <ButtonGroupItem id="delete" isDisabled iconLeading={<Dot className="mx-0.75 text-fg-success-secondary in-disabled:text-fg-disabled_subtle size-2" />}>
            Text
        </ButtonGroupItem>
    </ButtonGroup>
);
    ...
    <div className="flex flex-col gap-4">
        ...
        <ButtonGroup selectedKeys={["archive"]}>
            ...
            <ButtonGroupItem
                id="delete"
                isDisabled
                iconLeading={<Dot className="mx-0.75 text-fg-success-secondary in-disabled:text-fg-disabled_subtle size-2" />}
            >
                Delete
            </ButtonGroupItem>
        </ButtonGroup>
