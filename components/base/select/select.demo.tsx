...
export const DotLeadingDemo = () => {
    const items: SelectItemType[] = [
        {
            ...
            id: "@phoenix",
            supportingText: "@phoenix",
            icon: <Dot className="text-fg-success-secondary in-disabled:text-fg-disabled_subtle size-2.5" />,
        },
        {
            label: "Olivia Rhye",
            id: "@olivia",
    ...
    return (
        <Select
            ...
            hint="This is a hint text to help user."
            placeholder="Select team member"
            placeholderIcon={<Dot className="text-fg-success-secondary in-disabled:text-fg-disabled_subtle size-2.5" />}
            items={items}
        >
            {(item) => (
                <Select.Item id={item.id} supportingText={item.supportingText} isDisabled={item.isDisabled} icon={item.icon} avatarUrl={item.avatarUrl}>
