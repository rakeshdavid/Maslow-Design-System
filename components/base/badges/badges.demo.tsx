...
export const WithIconOnly = () => {
    return (
        <div className="flex flex-col items-start gap-4">
            {(Object.keys(filledColors) as BadgeColors[]).map((color) => (
                <div key={color} className="flex items-start gap-4">
                    <button aria-label="Add" className="outline-focus-ring cursor-pointer rounded-full focus-visible:outline-2 focus-visible:outline-offset-2">
...
export const WithIconOnlyBadgeColor = () => {
    return (
        <div className="flex flex-col items-start gap-4">
            {(Object.keys(filledColors) as BadgeColors[]).map((color) => (
                <div key={color} className="flex items-start gap-4">
                    <button aria-label="Add" className="outline-focus-ring cursor-pointer rounded-md focus-visible:outline-2 focus-visible:outline-offset-2">
